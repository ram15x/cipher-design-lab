  ...
  async evaluate(
    ...
    for (
      ...
      findings.push({
        ...
        message:
          `Duplicate class detected: ${duplicate}`,
    ...
    for (
      ...
      if (
        ...
        findings.push({
          ...
          message:
            `Class '${designClass.name}' has a very short responsibility description.`,
    ...
    for (
      ...
      if (
        ...
        findings.push({
          ...
          message:
            `Relationship source '${relationship.from}' is not declared as a class or interface.`,
      ...
      if (
        ...
        findings.push({
          ...
          message:
            `Relationship target '${relationship.to}' is not declared as a class or interface.`,
    ...
    if (
      ...
      findings.push({
        ...
        message:
          "The design does not describe any relationships between its components.",
    ...
    if (
      ...
      findings.push({
        ...
        message:
          "No explicit interface or variation point was described. This may be fine, but consider whether any behavior is likely to change.",
    ...
    if (
      ...
      findings.push({
        ...
        message:
          "Requirement understanding is quite brief and may not provide enough reasoning evidence.",
