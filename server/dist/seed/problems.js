export const problems = [
    {
        ...
        title: "Parking Lot",
        difficulty: "BEGINNER",
        brief: "Design a parking lot that supports multiple vehicle types, spot allocation, entry and exit, and fee calculation.",
        requirements: [
    ...
    },
    {
        ...
        difficulty: "BEGINNER",
        brief: "Design a vending machine that manages products, inventory, payments, selection, dispensing and refunds.",
        requirements: [
    ...
    },
    {
        ...
        brief: "Design a multi-elevator system that accepts requests and dispatches elevators while maintaining safe state transitions.",
        requirements: [
    ...
    },
    {
        ...
        difficulty: "INTERMEDIATE",
        brief: "Design a notification system capable of delivering user notifications through multiple channels.",
        requirements: [
