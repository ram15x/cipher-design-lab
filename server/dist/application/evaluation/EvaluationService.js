...
export class EvaluationService {
    ...
    evaluator;
    constructor(attemptRepository, problemRepository, evaluationRepository, evaluator) {
    ...
    async evaluateAttempt(attemptId) {
        ...
        const problem = await this.problemRepository
            .findBySlug(attempt.problemSlug);
        if (!problem) {
    ...
    async getLatestEvaluation(attemptId) {
        const evaluation = await this
            .evaluationRepository
            .findLatestForAttempt(attemptId);
        if (!evaluation) {
